...
public class Evento {
	...
	public Evento(int id_evento, String data, String horario_inicio, String horario_fim, String status, String nome, Admin usuario, List <Quadra> quadras) {
	...
	public Admin getServidor() {
		return usuario;
	}

	public void setServidor(Admin usuario) {
		this.usuario = usuario;
	}
