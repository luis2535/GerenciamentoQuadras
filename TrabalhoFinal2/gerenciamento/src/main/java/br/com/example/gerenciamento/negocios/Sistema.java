...
public class Sistema {
	...
	public void deletaServidor(Admin servidor) throws DeleteException {
		servidorDAO.delete(servidor);
	}
	public void atualizaServidor(Admin servidor) throws UpdateException {
		servidorDAO.update(servidor);
		usuarioDAO.update(servidor);
	}
	public Admin buscaServidor(String cpf) throws SelectException {
	...
	//----------------------------Bloco----------------------------//
	public void insereBloco(Bloco bloco) throws SelectException, InsertException, UpdateException{
